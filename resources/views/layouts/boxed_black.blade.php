  ...
  <body class="hold-transition skin-black-light layout-boxed sidebar-mini">
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        <!-- Logo -->
        <a href="https://doberman.herokuapp.com/" class="logo">
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="header"><a href="https://doberman.herokuapp.com/animations">Banner 1</a></li>
            <li class="header"><a href="https://doberman.herokuapp.com/animations">Banner 2</a></li>
            <li class="header"><a href="https://doberman.herokuapp.com/animations">Banner 3</a></li>
            <li class="header"><a href="https://doberman.herokuapp.com/animations">Banner 4</a></li>
            <li class="header"><a href="https://doberman.herokuapp.com/animations">Banner 5</a></li>
            <li class="header"><a href="https://doberman.herokuapp.com/animations">Banner 6</a></li>
            <li class="header"><a href="https://doberman.herokuapp.com/animations">Banner 7</a></li>
          </ul>
        </section>
        <!-- /.sidebar -->
      </aside>
