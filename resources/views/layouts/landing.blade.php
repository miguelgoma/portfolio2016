...
<div id="intro">
    <div class="container">
        <div class="row centered">
            ...
            <br>
            <div class="col-lg-3">
                <a href="http://localhost:8000/scrap"><img src="{{ asset('/img/intro01.png') }}" alt=""></a>
                <a href="http://localhost:8000/scrap"><h3>Scraping web</h3></a>
            ...
            <div class="col-lg-3">
                <a href="http://localhost:8000/cotiza"><img src="{{ asset('/img/intro02.png') }}" alt=""></a>
                <a href="http://localhost:8000/cotiza"><h3>Cotizador de autos</h3></a>
                <p>Cotiza tu seguro de auto en segundos</p>
            </div>
            <div class="col-lg-3">
                <a href="http://localhost:8000/voice"><img src="{{ asset('/img/intro03.png') }}" alt=""></a>
                <a href="http://localhost:8000/voice"><h3>Aplicación locutor</h3></a>
                <p>Consumo de la API voiceBunny</p>
            </div>
            <div class="col-lg-3">
                <a href="http://localhost:8000/gmaps"><img src="{{ asset('/img/intro03.png') }}" alt=""></a>
                <h3>Maps</h3>
        ...
        <div class="row centered">
            <br>
            <div class="col-lg-3">
                <a href="http://localhost:8000/crud"><img src="{{ asset('/img/intro01.png') }}" alt=""></a>
                <a href="http://localhost:8000/crud"><h3>CRUD</h3></a>
                <p>Crear, leer, actualizar y borrar</p>
            </div>
            <div class="col-lg-3">
                <a href="http://localhost:8000/banner"><img src="{{ asset('/img/intro02.png') }}" alt=""></a>
                <a href="http://localhost:8000/banner"><h3>Banners con GSAP JS</h3></a>
                <p>HTML5 animation</p>
            </div>
            <div class="col-lg-3">
                <a href="http://localhost:8000/webservice"><img src="{{ asset('/img/intro03.png') }}" alt=""></a>
                <a href="http://localhost:8000/webservice"><h3>Web services</h3></a>
        ...
        <div class="row centered">
            ...
            <div class="col-lg-3">
                <a href="http://localhost:8000/aplication"><img src="{{ asset('/img/intro02.png') }}" alt=""></a>
                <a href="http://localhost:8000/aplication"><h3>Aplication</h3>
                <p>Aplication</p></a>
            </div>
            <div class="col-lg-3">
                <a href="http://localhost:8000/stripe"><img src="{{ asset('/img/intro03.png') }}" alt=""></a>
                <a href="http://localhost:8000/stripe"><h3>Ecommerce</h3></a>
                <p>Stripe</p>
            </div>
            <div class="col-lg-3">
                <a href="http://localhost:8000/about"><img src="{{ asset('/img/user2-160x160.jpg') }}" alt=""></a>
                <h3>Acerca de </h3>
                <p></p>
            </div>
        </div>
